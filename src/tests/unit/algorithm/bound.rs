...
mod tests {
    ...
    fn bound_intersect() {
        ...
        let test_data = [
            (
                Bound::new(2., 4.).unwrap(),
                Bound::new(0., 1.).unwrap(),
                Bound::None,
            ),
            (
                Bound::new(2., 4.).unwrap(),
                Bound::new(4., 5.).unwrap(),
                Bound::None,
            ),
            (
                Bound::new(2., 4.).unwrap(),
                Bound::new(1., 3.).unwrap(),
                Bound::new(2., 3.).unwrap(),
            ),
            (
                Bound::new(2., 4.).unwrap(),
                Bound::new(1., 5.).unwrap(),
                Bound::new(2., 4.).unwrap(),
            ),
            (
                Bound::new(2., 4.).unwrap(),
                Bound::new(3., 5.).unwrap(),
                Bound::new(3., 4.).unwrap(),
            ),
            (
                Bound::new(2., 4.).unwrap(),
                Bound::new(2., 3.).unwrap(),
