...
mod tests {
    ...
    use crate::algorithm::entities::data::loads::{AssignmentType, LoadUnitData, UnitCargoType};
    ...
    fn strength_area() {
        ...
        let timber_bound = IcingTimberBoundCtx::new(10.0, 30.0, IcingTimberType::Full);

        let mock_eval = MockEval {
            ctx: ctx.write(timber_bound).unwrap(),
        };
