                    ...
                    IcingCoeffEval::new(
                        ...
                        UnitAreaEval::new(
                            ...
                            Initial::new(
                                &dbg,
                                Arc::clone(&api_client),
                                Context::new(InitialCtx::new(&ship_id, &project_id, bounds, vec!["224".to_owned()])),
                            ),
                        ),
                    ),
                ),
