...
pub struct Context {
    ...
    /// Координаты 3D модели импортированные из Диалог Статика
    pub(super) converted_3d_model: Option<ConvertToTrimeshCtx>,
    ///
