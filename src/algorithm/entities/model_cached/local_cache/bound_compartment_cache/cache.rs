...
pub struct BoundCompartmentCache {
    dbg: Dbg,
    cache_path: PathBuf,
    draught_step: f64,
    length_lbp: f64,
...
impl BoundCompartmentCache {
    ...
    pub fn new(
        ...
        let dbg = Dbg::new(parent, format!("BoundCompartmentCache"));
    ...
    fn calculate(&mut self) -> Result<(), Error> {
        ...
        let data = super::build_cache::BuildBoundCompartmentCache::new(
            &self.dbg,
            self.shape.clone(),
            self.draught_step,
            self.bounds.clone(),
