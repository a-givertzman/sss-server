...
use crate::algorithm::entities::{Bounds, model_cached::position};
///
...
impl Draught {
    ...
    pub fn calculate(&self, bounds: Bounds) -> (f64, f64, f64) {
        ...
        let draught_mean = self.draught_mid
            + (self.waterline_x - self.midel_x) * trim_m / self.length_lbp
