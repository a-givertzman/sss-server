use crate::algorithm::entities::{model::{local_cache::bound_cache::build_bound_cache::BuildBoundCache, LocalCache}, Position};
#[cfg(test)]
use crate::algorithm::entities::model::{
    local_cache::bound_cache::{
        bound_cache_conf::BoundCacheConf,
        BoundCache,
    },
    ModelTree,
};
...
#[test]
fn calculated_bound_cache() {
    DebugSession::init(LogLevel::Info, Backtrace::Short);
    init_once();
    init_each();
    let dbg = Dbg::new("test models", "Calculated_bound_cache");
    log::debug!("\n{}", dbg);
    ...
    let target_path =
        "src/algorithm/entities/model/local_cache/bound_cache/tests/assets/fpc_target";
    let result_path = "src/algorithm/entities/model/local_cache/bound_cache/tests/assets";
  //      "src/algorithm/entities/model/local_cache/bound_cache/tests/assets/fpc_result";
 ...
 /*   let errors = BuildBoundCache::new(
        &dbg,
